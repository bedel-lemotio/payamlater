...
import '../../features/product/views/list_product.dart';
import 'bottom_curved_Painter.dart';

class CustomBottomNavigationBar extends StatefulWidget {
  final Function(int) onIconPresedCallback;
  final Function(int) onItemSelected;
  CustomBottomNavigationBar({required this.onIconPresedCallback, required this.onItemSelected});
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? Color(0xFF9FE2FF) : Colors.white,
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.store, _selectedIndex == 1, 1),
                _icon(Icons.dashboard, _selectedIndex == 2, 2),
